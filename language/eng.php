...
define("TITLE_WORK_4", "Associazione folkloristica corale 'lu passarielle'");
...
define("DESCRIPTION_WORK4", "I realised the blog 'Associazione Folkloristica corale Lu Passarielle' using the tool blogspot. I added different functionality to the blog using the programming languages html5 and javascript.");
