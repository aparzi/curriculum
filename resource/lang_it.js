...
var DESCRIPTION_DATASOUNDS = "Ho callaborato per poco pi&ugrave di un anno con lo spin-off del Molise, <a style='color: red; cursor: pointer;' href='https://datasounds.io/' target='_blank'>Datasounds</a>. Ho svolto il ruolo dello sviluppatore, nello specifico mi occupavo del frontend utilizzando lo stack tecnologico javascript. Il team con cui ho lavorato era formato in genere da 3/4 persone, pi&ugrave il senior.";
var DESCRIPTION_GRS = "Ho realizzato il sito web per GRS 2017 (Giornate della Ricerca Scientifica) un evento che si è tenuto all'università del Molise nello specifico alla sede di Pesche. Il lavoro l'ho realizzato usando tecnologie quali: bootstrap, html e javascript.";
var DESCRIPTION_SANER_2018 = "Ho realizzato il sito di Saner 2018, conferenza internazionale sulla manutenzione dei sistemi software, facendo uso delle tecnologie per il web come il php e javascript.";
var NON_TERMINATO = "in corso";

/**************************** EDUCTION ****************************************/
var TITLE_DIPLOMA = "PERITO ELETTRONICO";
var DESCRIPTION_DIPLOMA = "Conseguimento del diploma in operatore elettronico, presso l' Istituto Professionale Industria e Artigianato situato a Campobasso (CB).";
